...
const AboutUs = () => {
    ...
    return (
        <section className="bg-gray-50 py-20 dark:bg-neutral-800">
            {/* Section Header */}
            ...
            {/* Cards Section */}
            <div className="container mx-auto px-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mt-14">
                {cards.map((card, index) => (
                    <motion.div
                        key={index}
                        className="bg-white dark:bg-neutral-900 shadow-lg rounded-3xl p-8 flex flex-col items-center text-center transform transition-all duration-300 hover:shadow-2xl"
                    ...
                    >
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-md leading-relaxed">{card.text}</p>
                    </motion.div>
                ))}
            </div>
        </section>
