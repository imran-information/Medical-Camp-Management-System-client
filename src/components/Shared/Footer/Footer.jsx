        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 p-4">
          ...
          <div>
            ...
            <p className="text-sm opacity-75 mb-4">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, do eiusmod tempor incididunt ut labore dolore magna.
            </p>
            <div className="flex space-x-4">
          ...
          <div>
            ...
            <div className="h-1 w-10 bg-white mb-4"></div>
            <p className="text-sm opacity-75 mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
